...
## **Conclusion**
Although all of the models beat the baseline the Logistic Regression, Random Forest and XG Booster were all cery close. The Decision Tree model did not fare as well as the others but still beat the baseline also. There are many ways to improve scores here but one would have to go through the code line by line. Perhaps I did too much modeling, maybe leaving in longitude, latitude and property id caused leakage, but the only way to tell would for one to take a totally different approach to this. This was great fun putting together, but how relevant are these models in 2020? Probably that much, especially with Covid changing the way Air BnB property owbers can conduct business. However, in 2016 this project would have been a great guid for me recommending rentals to my out of town visitors. 
