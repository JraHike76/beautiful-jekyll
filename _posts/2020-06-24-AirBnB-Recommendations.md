...
## **Logistic Regression**
The initiallinear model I chose was logistic regression with ordinal encoding, which gave me an accuracy score of 65%, beating the baseline by 12 percentage points. I was surprised by the jump in accuracy so I wanted to take a look at the coefficients as they are great estimates of the unknown population parameters, therefore the model depends on coefficients for accurate predictions.   
